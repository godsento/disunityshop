...
public:
	void init() {
		...
		indicators.setup(XOR("indicators"), XOR("indicators"));
		...
		localdebug.setup(XOR("local debug information"), XOR("fuckmyholesuwu"), true, true);
		RegisterElement(&localdebug, 1);
	}
};
...
public:
	void init() {
		...
		hitmarkerop.setup(XOR("hitmarker options"), XOR("hitmarkoptions"), {XOR("Indicate Shot Damage"), XOR("World Hitmarker")}, true);
		RegisterElement(&hitmarkerop, 1);
...
public:
	...
	void init() {
		...
		i_color.setup(XOR("indicators color"), XOR("indicators color"), colors::burgundy, &g_gui.i_color);
		RegisterElement(&i_color);
		...
		gradientslider.setup(XOR("gradient slider"), XOR("gradslid"));
		RegisterElement(&gradientslider);

		secondarycolor.setup(XOR("grad 2nd color"), XOR("grs"), colors::burgundy, &g_gui.s_color);
		RegisterElement(&secondarycolor);
...
public:
	Checkbox mouse;
	Checkbox extrapolate;

public:

	void init() {
		SetTitle(XOR("testingstuff"));
		
		mouse.setup(XOR("ot mousefix"), XOR("otmf"));
		RegisterElement(&mouse);
		
		extrapolate.setup(XOR("rape extrapolation"), XOR("extrapols"));
		RegisterElement(&extrapolate);
	}
