...
void render::init() {
	...
	hud = Font(XOR("Corbel"), 22, FW_BOLD, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	cs = Font(XOR("Counter-Strike"), 28, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	indicator = Font(XOR("Corbel"), 14, FW_BOLD, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	logevent = Font(XOR("Small Fonts"), 12, FW_NORMAL, FONTFLAG_OUTLINE);
}
