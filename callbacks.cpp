...
void callbacks::ConfigLoad1() {
	...
	g_config.load(&g_menu.main, XOR("1.lev"));
...
void callbacks::ConfigLoad2() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("2.lev"));
...
void callbacks::ConfigLoad3() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("3.lev"));
...
void callbacks::ConfigLoad4() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("4.lev"));
...
void callbacks::ConfigLoad5() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("5.lev"));
...
void callbacks::ConfigLoad6() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("6.lev"));
...
void callbacks::ConfigLoad() {
	...
	std::string file = tfm::format(XOR("%s.lev"), config.data());
