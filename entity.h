...
//////////////////////////////////////////////////////////
	...
	//ANIMATION_LAYER_WEAPON_ACTION, // 1
	//ANIMATION_LAYER_WEAPON_ACTION_RECROUCH, // 2
	//ANIMATION_LAYER_ADJUST, // 3
	//ANIMATION_LAYER_MOVEMENT_JUMP_OR_FALL, // 4
	//ANIMATION_LAYER_MOVEMENT_LAND_OR_CLIMB, //5
	//ANIMATION_LAYER_MOVEMENT_MOVE, // 6
	//ANIMATION_LAYER_MOVEMENT_STRAFECHANGE, //7
	//ANIMATION_LAYER_WHOLE_BODY, //8 
	//ANIMATION_LAYER_FLASHED, //9
	//ANIMATION_LAYER_FLINCH, //10
	//ANIMATION_LAYER_ALIVELOOP, //11
	//ANIMATION_LAYER_LEAN, //12
